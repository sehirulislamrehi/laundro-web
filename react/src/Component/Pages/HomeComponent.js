...
const HomeComponent = () => {
     return(
          <div className="id">
                              ...
                              <div className="row align-items-center">
                                   <div className="col-1">
                                        <div className="logo-wrapper">
                                             <a href="index.html" className="desktop-logo"><img src="/images/logo.png"
                                                       alt="" /></a>
                                        </div>
                                   </div>
                         ...
                         >
                              ...
                              <div className="item">
                                   ...
                                   <div className="banner_image_block">
                                        <img src="/images/bg-slider4.jpg" className="img-fluid" alt=""></img>
                                   </div>
                                   </div>
                              </div>
                              {/* banner item end */}
               ...
               {/* Footer */}
               <footer className="bixol-footer" data-background="images/footer-bg.jpg">
