<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">View Area : {{ $area->name }}</h5>
          ...
          <div class="col-sm-12">
               <table class="table table-bordered table-sm">
                    <tbody>
                         ...
                         <tr>
                              <td>Zipcode</td>
                              <td>{{ $area->zipcode ? $area->zipcode->code : 'N/A' }}</td>
                         </tr>
                         <tr>
                              <td>Status</td>
                              <td>
                         ...
                         <tr>
                              ...
                              <td>
                                   <ul style="padding-left: 15px;">
                                    <li >
                                            @php
                                                $parent_location = parent_location($area->id)
                                            @endphp
                         ...
                         <tr>
                              <td>Last Update</td>
                              <td>{{ $area->updated_at->toDayDateTimeString() }}</td>
                         </tr>
                    </tbody>
               </table>
          </div>
