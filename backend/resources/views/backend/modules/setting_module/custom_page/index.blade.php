...
<div class="br-mainpanel">
     <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
               ...
               <a class="breadcrumb-item active" href="#">All Custom Pages</a>
          </nav>
     </div>
               ...
               <div class="col-md-12">
                    <div class="card card-primary card-outline table-responsive">
                         <div class="card-header text-right">
                              ...
                              <button type="button" data-content="{{ route('custom_page.add.modal') }}" data-target="#largeModal" class="btn btn-outline-dark" data-toggle="modal">
                                   Add
                              </button>
                              @endif
                         </div>
