...
<div class="modal-body">
     <form class="ajax-form" method="post" action="{{ route('faq.edit', encrypt($faq->id)) }}">
          @csrf
          ...
          <div class="row">
               ...
               <div class="col-md-12 col-12 form-group">
                    ...
                    <input type="number" class="form-control" name="position" value="{{ $faq->id }}">
               </div>
               ...
               <div class="col-md-12 col-12 form-group">
                    ...
                    <textarea name="answer" rows="3" class="form-control">{{ $faq->answer }}</textarea>
               </div>
               ...
               <div class="col-md-12 col-12 form-group">
                    ...
                    <select name="is_active" class="form-control">
                         ...
                         <option value="0" @if( $faq->is_active == 0 ) selected @endif >In active</option>
                    </select>
               </div>
